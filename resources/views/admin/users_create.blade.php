...
<form enctype="multipart/form-data" action="{{ route('users.store') }}" method="post">
  {{ csrf_field() }}
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputUserName" name="name" placeholder="John Doe"
        required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputUserEmail" name="email" placeholder="johndoe@test.com"
        required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputUserPhone" name="phone" placeholder="081212341234"
        required>
    </div>
