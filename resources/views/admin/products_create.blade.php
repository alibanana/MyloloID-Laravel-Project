  ...
  <div class="container">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputProductName" name="productName"
        placeholder="Mylo Crop Sleeve Denim" required>
    </div>

    {{-- Product Description --}}
    <div class="form-group">
      <label for="inputProductDescription">Description</label>
      <textarea class="form-control" id="inputProductDescription" name="productDescription"
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="inputProductPrice" name="productPrice" placeholder="449000"
        required>
    </div>
    ...
    <div class="form-group mb-0">
      ...
      <div class="row" id="inputColourRow">
        <div class="col-4 mb-4">
          <select id="inputColour" class="form-control" name="materials[]" required>
    ...
    <div class="form-group mb-0">
      ...
      <div class="row" id="inputSizeRow">
        <div class="col-4 mb-4">
          <select id="inputSize" class="form-control" name="materials[]" required>
